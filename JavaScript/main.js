...
function language() {
  if (window.localStorage.getItem("language") == "ar") {
    document.querySelector(".logo").innerHTML = "هيرو";
    ...
    document.querySelector(".land-left h1").innerHTML = "مرحبا, فى عالم عبدالرحمن";
    ...
    document.querySelector(".footer h3").innerHTML = "عبدالرحمن";
    ...
    document.querySelector(".footer .copyright").innerHTML =
      " مصنوع من <3 بواسطة عبدالرحمن";
    phrases = [
      "مرحبك فى عالم عبدالرحمن",
      "مرحبك فى عالم وليد",
      "صناعه اسامة ",
      "حدثه عبدالرحمن وليد",
    ];
    ...
    document.querySelector(".logo").innerHTML = "Hero";
    ...
    document.querySelector(".land-left h1").innerHTML =
      "Welcome, To Abdelrahman's World";
    document.querySelector(".land-left p").innerHTML =
    ...
    document.querySelector(".footer h3").innerHTML = "Abdelrahman";
    document.querySelector(".footer .text").innerHTML =
    ...
    document.querySelector(".footer .copyright").innerHTML =
      "Made With <3 By Abdalrhman";
    phrases = [
      "Welcome To Abdelrahman's World",
      "Welcome To Walid World",
      "Made With Osama ",
      "Update With Abdalrhman ",
    ];
    document.querySelector(".landing .land-left h1").style.borderRight =
      "5px solid";
    document.querySelector(".landing .land-left h1").style.borderLeft =
